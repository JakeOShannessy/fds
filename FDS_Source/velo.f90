   ...
   DO K=1,KBAR
      DO J=1,JBAR
         DO I=1,IBAR
            ...
            IF (SOLID(CELL_INDEX(I,J,K))) CYCLE
            YY_GET(:) = YYP(I,J,K,:)
            CALL GET_VISCOSITY(YY_GET,MU(I,J,K),TMP(I,J,K))
         ENDDO
      ENDDO
   ENDDO
   !$OMP END DO
...
!    CS = CSMAG
!    !$OMP DO COLLAPSE(3) PRIVATE(K,J,I,DELTA,DUDX,DVDY,DWDZ,DUDY,DUDZ,DVDX,DVDZ,DWDX,DWDY,S12,S13,S23,SS,NU,RE_DELTA,RE_EMC)
!    DO K=1,KBAR
!       DO J=1,JBAR
!          DO I=1,IBAR
   ...
   SELECT CASE(BOUNDARY_TYPE(IW))
      CASE(SOLID_BOUNDARY)
         IF (N_SPECIES>0 .AND. .NOT.EVACUATION_ONLY(NM)) THEN
            ...
            CALL GET_VISCOSITY(YY_GET,MU_WALL,TMP(IIG,JJG,KKG))
         ELSE
...
REAL(EB) :: UODX,VODY,WODZ,UVW,UVWMAX,R_DX2,MU_MAX,MUTRM,CP,YY_GET(1:N_SPECIES),TMP_WGT
...
!$OMP        NEWC,BOUNDARY_TYPE,VENT_INDEX,VENTS,TW,T_BEGIN,T,UU,VV,WW,IJKW)
