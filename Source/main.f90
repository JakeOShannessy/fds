...
USE OUTPUT_DATA
USE MEMORY_FUNCTIONS, ONLY: EXCHANGE_GEOMETRY_INFO,CHKMEMERR,ALLOCATE_STORAGE,PACK_PARTICLE,&
                            NULLIFY_PARTICLE,PACK_WALL,REALLOCATE_P_ZONE,REALLOCATE_CELL,REALLOCATE_STORAGE_ARRAYS,&
                            RE_ALLOCATE_STRINGS,PACK_THIN_WALL
USE HVAC_ROUTINES
...
CHARACTER(250) :: JSON_OUTPUT_PATH=''
...
IF (OUTPUT_JSON) THEN
   WRITE(LU_ERR,'(A)') ' Outputting JSON info...'
   CALL PRINT_JSON(JSON_OUTPUT_PATH)
